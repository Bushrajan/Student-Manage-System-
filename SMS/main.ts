...
async function SMS() {
    class student {
        ...
        constructor(name: string, age: number, religion: string, cnic: number, id: string, course: string, balance: string, istitute: string) {
            this.name = name;
            this.age = age;
        ...
        public get student_age() {
            return this.age;
        }
        public get student_religion() {
            return this.religion;
        }
        public get student_cnic() {
            return this.cnic;
        }
        public get student_course() {
            return this.course;
        }
        public get student_institute() {
